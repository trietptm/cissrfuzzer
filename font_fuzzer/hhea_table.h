...
extern hhea_table gener_hhea_table(short param[9], uint16 hmetrixNum);
extern uint32 hhea_table_size();
extern TableDirectoryNod gener_hhea_table_header(uint32 offSet);
